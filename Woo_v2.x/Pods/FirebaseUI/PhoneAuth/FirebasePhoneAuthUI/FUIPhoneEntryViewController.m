...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  if (indexPath.row == FUIPhoneEntryRowCountrySelector) {
    ...
    NSLog(@"country code = %@",_countryCodeField.text);
...
- (void)setCountryCodeValue {
  ...
  _countryCodeField.text = countruCode;
    NSLog(@"country code = %@",_selectedCountryCode.dialCode);
    
    [[NSUserDefaults standardUserDefaults] setObject: [NSString stringWithFormat:@"+%@", _selectedCountryCode.dialCode] forKey:@"kCountyCodeForFIrebasePhoneAuthentication"];
