...
//  Woo_v2
//
//  Created by Akhil Singh on 06/03/19.
...
@objc public protocol ChatTextViewDelegate: UITextViewDelegate {
    @objc optional func textViewDidChangeHeight(_ textView: ChatTextView, height: CGFloat)
    @objc optional func textViewDidChangeText(_ textView: ChatTextView)
}
...
open class ChatTextView: UITextView {
    ...
    override open func layoutSubviews() {
        ...
        if height != heightConstraint!.constant {
            ...
            if let delegate = delegate as? ChatTextViewDelegate {
    ...
    @objc func textDidEndEditing(notification: Notification) {
        if let sender = notification.object as? ChatTextView, sender == self {
