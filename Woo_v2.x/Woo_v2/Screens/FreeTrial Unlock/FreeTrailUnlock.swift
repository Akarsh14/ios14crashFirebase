//
//  FreeTrailUnlockEveryThingViewController.swift
//  Woo_v2
//
//  Created by Harish kuramsetty on 01/08/19.
//  Copyright © 2019 Woo. All rights reserved.
//

import UIKit

class FreeTrailUnlock: UIView {
   ...
   // var screenType:PurchaseType = .freeTrial
    ...
    //        purchaseObj.hitWooPlusAPIForFreeTrail(storeID: "com.wooplusFreeTrail.above24_1Month", planID: FreeTrailModel.sharedInstance().planId)
    //    }
