...
class ALChatManager: NSObject {
    ...
    static let applicationId = AppLozicAuthenticationKey
   ...
   @objc init(applicationKey: NSString) {
    ...
    //----------------------
     ...
     @objc func connectUserWithCompletion(_ alUser: ALUser, completion : @escaping (_ response: ALRegistrationResponse?, _ error: NSError?) -> Void) {
