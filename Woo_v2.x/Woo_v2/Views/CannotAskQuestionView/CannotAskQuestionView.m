...
#import "CannotAskQuestionView.h"

@implementation CannotAskQuestionView
...
-(id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        NSArray *viewArrayFromXib = [[NSBundle mainBundle] loadNibNamed:@"CannotAskQuestionView" owner:self options:nil];
