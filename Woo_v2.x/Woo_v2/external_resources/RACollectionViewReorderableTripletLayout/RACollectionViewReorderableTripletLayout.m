...
- (void)handlePanGesture:(UIPanGestureRecognizer *)pan
{
    switch (pan.state) {
        ...
        case UIGestureRecognizerStateCancelled:
        case UIGestureRecognizerStateEnded:
            if ([self.datasource respondsToSelector:@selector(collectionView:movementEndedAtIndexPath:)]) {
                [self.datasource collectionView:self.collectionView movementEndedAtIndexPath:_reorderingCellIndexPath];
            }
            [self invalidateDisplayLink];
            break;
