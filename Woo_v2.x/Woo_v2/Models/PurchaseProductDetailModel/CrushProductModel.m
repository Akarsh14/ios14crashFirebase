...
@implementation CrushProductModel
...
- (void)addWithData:(NSDictionary *)dictData{
    ...
    if([dictData objectForKey: kComboProductDto])
        self.comboDto = [[WooGlobalProductModel alloc] initWithData:[dictData objectForKey: kComboProductDto]];
...
- (void)encodeWithCoder:(NSCoder *)encoder
{
    ...
    if (self.comboDto) {
        [encoder encodeObject:self.comboDto forKey:@"comboDto"];
...
- (id)initWithCoder:(NSCoder *)decoder
{
    ...
    if( self != nil )
    {
        ...
        if ([decoder decodeObjectForKey:@"comboDto"])
        {
            self.comboDto = [decoder decodeObjectForKey:@"comboDto"];
        }
    }
    return self;
}
